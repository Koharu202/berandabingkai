...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <select id = "twibbonimg">
      <option value="teacherday.png">Hari Guru</option>
      <option value="youthchildrenday.png">Hari Anak Internasional</option>
      <option value="bicycleday.png">Sepedaan</option>
      <option value="tahun.png">Ulang Tahun</option>
      <option value="pramuka.png">Gerakan Pramuka</option>
